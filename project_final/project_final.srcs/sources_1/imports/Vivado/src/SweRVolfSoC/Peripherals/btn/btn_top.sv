...
Debugging starting position of the Player Sprite
	    ...
	    */
        ...
        case(btn_m2s_adr_i[5:2])
            1:  btn_row_reg <= btn_ack_ff && btn_m2s_we_i ? btn_m2s_dat_i : btn_row_reg;     
            2:  btn_col_reg <= btn_ack_ff && btn_m2s_we_i ? btn_m2s_dat_i : btn_col_reg;
        endcase
...
assign btn_s2m_dat_o = (btn_m2s_adr_i[5:2]>0) ? (btn_m2s_adr_i[5:2]>1) ? btn_col_reg : btn_row_reg : btn_data_reg;
assign btn_col_o = btn_col_reg;
assign btn_row_o = btn_row_reg;
